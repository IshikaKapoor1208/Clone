        ...
        >
          <div className="max-w-[31rem]">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a
                href="#project-01"
                className="magnetic cursor-arrow inline-flex items-center justify-center border border-[#212020] bg-[#212020] px-6 py-3 text-[0.66rem] uppercase tracking-[0.24em] text-white transition hover:bg-[#111111]"
              ...
              <a
                href="#contact"
                className="magnetic cursor-arrow inline-flex items-center justify-center border border-black/22 bg-transparent px-6 py-3 text-[0.66rem] uppercase tracking-[0.24em] text-black/72 transition hover:border-black/45 hover:text-black"
