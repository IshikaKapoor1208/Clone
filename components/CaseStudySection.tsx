...
export default function CaseStudySection({
  ...
  return (
    <section
      ref={sectionRef}
      id={id}
      className="relative border-t border-black/8 bg-white px-6 py-8 md:sticky md:top-0 md:min-h-[130vh] md:px-10 md:py-8 lg:min-h-[140vh]"
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-[96rem] grid-cols-1 gap-10 md:h-screen lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
        <div>
          <div>
